  ...
  return (
    <footer>
      <div className="flex max-md:flex-col items-center justify-center gap-8 px-8 pt-8">
        <div className="grid grid-cols-5 max-md:grid-cols-4 max-sm:grid-cols-2 gap-8 flex-shrink-0">
          {footer.map((footer_group_item, index) => (
            <ul key={index}>
              ...
              {footer_group_item.items.map((footer_item, index_2) => (
                <li key={index_2}>
                  <a href={footer_item.url}>{footer_item.title}</a>
                </li>
              ))}
            </ul>
          ))}
        ...
        <div className="space-y-2">
          ...
          <TypographyP className="text-md">
            Subscribe to the Next Starter newsletter and stay updated on new
      ...
      <div className="px-8 pb-8">
        <TypographyH3 className="font-extrabold">Next Starter</TypographyH3>
